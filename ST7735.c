...
//------------ST7735_DrawString------------ // bruh LOOK AT THIS ONE!
...
void ST7735_OutChar(char ch){
  ...
  ST7735_DrawCharS(StX*6,StY*10,ch,StTextColor,ST7735_WHITE, 1);			//Changes the color of the text and the color of the text's bg
  StX++;
  if(StX>20){
    StX = 20;
    ST7735_DrawCharS(StX*6,StY*10,'*',ST7735_RED,ST7735_BLACK, 1);		//If text goes off screen, replace with blinking red * with black bg
  }
  return;
}
//********ST7735_OutString*****************
...
void Output_Init(void){
  ...
  ST7735_InitR(INITR_REDTAB);											//INITR_BLACKTAB invert the color
  ST7735_FillScreen(ST7735_WHITE);                // set screen to whatever color
}
